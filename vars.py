...
# API Configuration
API_ID = int(os.environ.get("API_ID", "28402693"))

API_HASH = os.environ.get("API_HASH", "fbf945420f57cce13ee8b9996420718a")
...
ADMINS = [int(x) for x in os.environ.get("ADMINS", "7128895552").split()]  # Default to owner ID

# Channel Configuration
PREMIUM_CHANNEL = "https://t.me/+zzgp8DUgaic3MzR"
